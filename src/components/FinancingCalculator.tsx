...
export default function FinancingCalculator({ isOpen, onClose }: FinancingCalculatorProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] p-4 overflow-y-auto flex justify-center items-start">
      ...
      {/* Modal Container */}
      <section className="relative w-full max-w-[950px] mt-12 mb-12 px-6 pt-[55px] pb-10 rounded-[4px] border border-white/10 bg-[#050505] shadow-[0_0_100px_rgba(29,209,161,0.1)]">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 bg-[#0B0E14] border border-[#1dd1a1]/20 rounded-[4px] p-6 shadow-[0_30px_80px_-20px_rgba(29,209,161,0.15)]">
         
         {/* Calculator Side */}
         <div className="space-y-10">
            <div className="flex items-center gap-4 border-b border-white/10 pb-6">
              <div className="w-12 h-12 rounded-[4px] bg-white/5 flex items-center justify-center text-[#1dd1a1]">
                <Calculator size={24} />
              </div>
              <div>
               ...
               <div className="flex flex-wrap gap-3">
                  {[12, 24, 36, 48, 60].map(m => (
                    <button 
                      ...
                      className={`flex-1 py-3 border rounded-[4px] font-black text-sm transition-all
                        ${installments === m 
            ...
            {/* Result Box */}
            <div className="mt-8 p-6 bg-black/40 rounded-[4px] border border-white/5 relative overflow-hidden">
         ...
         <div className="relative">
            ...
            <form onSubmit={submitLead} className="flex flex-col h-full justify-between space-y-8 lg:pl-6">
               ...
               <div className="space-y-5">
                  <div className="space-y-2">
                     ...
                     <input 
                        ...
                        className="w-full bg-[#050505] border border-white/5 rounded-[4px] py-4 px-6 text-sm text-white placeholder:text-[#333] focus:border-[#1dd1a1]/50 outline-none transition-all"
                     />
                  </div>
                  <div className="space-y-2">
                     ...
                     <input 
                        ...
                        className="w-full bg-[#050505] border border-white/5 rounded-[4px] py-4 px-6 text-sm text-white placeholder:text-[#333] focus:border-[#00f3ff]/50 outline-none transition-all"
                     />
                  </div>
                  <div className="space-y-2">
               ...
               {/* Action Button */}
               <button type="submit" className="w-full flex items-center justify-between p-2 pl-8 bg-[#1dd1a1] text-black rounded-[4px] group overflow-hidden relative shadow-[0_0_20px_rgba(29,209,161,0.2)] hover:shadow-[0_0_40px_rgba(0,243,255,0.3)] transition-all duration-300">
                  ...
                  <div className="w-12 h-12 bg-black rounded-[4px] flex items-center justify-center relative z-10">
