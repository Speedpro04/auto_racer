    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center gap-2 bg-[#1dd1a1] text-[#0A0A0A] px-5 py-2.5 rounded-[12px] hover:bg-white hover:text-gray-800 transition font-black uppercase tracking-tighter text-sm"
        >
      ...
      {loading ? (
        ...
        <div className="bg-[#14181C] rounded-[15px] p-16 text-center border border-[#1dd1a1]/30 shadow-2xl">
          ...
          <Link
            to="/admin/veiculos/novo"
            className="inline-flex items-center gap-2 bg-[#1dd1a1] text-[#0A0A0A] px-10 py-4 rounded-[12px] hover:bg-white hover:text-gray-800 transition font-black uppercase tracking-widest text-[11px]"
          >
