          ...
          >
            <div className="bg-gradient-to-br from-[#1dd1a1]/10 to-transparent border border-[#1dd1a1]/20 rounded-[40px] p-10 text-center">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-[#1dd1a1] text-black px-6 py-6 rounded-2xl hover:bg-white hover:text-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 font-black uppercase text-xs tracking-[0.2em] shadow-[0_20px_40px_rgba(29,209,161,0.3)] disabled:opacity-50"
              >
                {loading ? (
