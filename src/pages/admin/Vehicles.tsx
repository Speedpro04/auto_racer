    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center gap-2 bg-[#1dd1a1] text-[#0A0A0A] px-5 py-2.5 rounded-[4px] hover:bg-white hover:text-gray-800 transition font-black uppercase tracking-tighter text-sm"
        >
      ...
      <div className="relative max-w-xl">
        ...
        <input
          ...
          className="w-full bg-[#2d3436] text-white pl-14 pr-6 py-4 rounded-[4px] border border-white/5 focus:border-[#1dd1a1] outline-none transition font-medium"
        />
      </div>
      ...
      {loading ? (
        <div className="space-y-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-[#14181C] rounded-[4px] p-6 animate-pulse border border-[#262626]">
              <div className="flex items-center gap-6">
                <div className="w-24 h-24 bg-black rounded-[4px]"></div>
                <div className="flex-1 space-y-3">
                  <div className="h-4 bg-black rounded-[4px] w-1/4"></div>
                  <div className="h-4 bg-black rounded-[4px] w-1/8"></div>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="bg-[#14181C] rounded-[4px] p-16 text-center border border-[#1dd1a1]/30 shadow-2xl">
          ...
          <Link
            to="/admin/veiculos/novo"
            className="inline-flex items-center gap-2 bg-[#1dd1a1] text-[#0A0A0A] px-10 py-4 rounded-[4px] hover:bg-white hover:text-gray-800 transition font-black uppercase tracking-widest text-[11px]"
          >
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredVehicles.map((vehicle) => (
            <div
              key={vehicle.id}
              className="bg-[#2d3436] rounded-[4px] p-6 border border-white/5 hover:border-[#1dd1a1] transition-all duration-300 group shadow-lg"
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-6 w-full md:w-auto">
                  <div className="w-24 h-24 bg-black rounded-[4px] border border-white/5 overflow-hidden flex items-center justify-center flex-shrink-0 group-hover:border-[#1dd1a1]/30 transition-colors">
                    {vehicle.media?.[0]?.url ? (
                      <img
                ...
                <div className="flex items-center gap-3 w-full md:w-auto mt-4 md:mt-0 pt-4 md:pt-0 border-t md:border-t-0 border-white/5">
                  <span
                    className={`px-3 py-1.5 rounded-[4px] text-[10px] font-black uppercase tracking-widest ${
                  ...
                  <div className="flex items-center gap-2 flex-1 md:flex-none justify-end">
                    <Link
                      ...
                      target="_blank"
                      className="p-3 text-[#555] hover:text-white hover:bg-white/5 rounded-[4px] transition"
                      title="Ver Vitrine"
                    >
                    ...
                    <Link
                      ...
                      className="p-3 text-[#555] hover:text-[#1dd1a1] hover:bg-[#1dd1a1]/10 rounded-[4px] transition"
                      title="Editar"
                    >
                    ...
                    <button
                      ...
                      className="p-3 text-[#555] hover:text-[#ff6b6b] hover:bg-[#ff6b6b]/10 rounded-[4px] transition"
                      title="Excluir"
                    >
