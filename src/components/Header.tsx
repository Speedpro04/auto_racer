      ...
      <div className="max-w-[1140px] mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <Link
              to="/login"
              className="px-6 py-2.5 bg-white/5 border border-white/10 rounded-[4px] text-[10px] font-black uppercase tracking-widest text-white hover:bg-[#1dd1a1] hover:text-gray-800 hover:border-transparent transition-all duration-300"
            >
